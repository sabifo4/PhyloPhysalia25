* [[ INPUT/OUTPUT FILES AND SEED NUMBER ]]
       ...
       seqfile = mtCDNApri.phy     * Path to the input sequence file
      treefile = mtCDNApri.trees   * Path to the input tree file
...
* [[ EVOLUTIONARY MODEL ]]
    ...
    aaRatefile = lg.dat   * Path to the file with the substitution matrix
                          * In this case, LG matrix
