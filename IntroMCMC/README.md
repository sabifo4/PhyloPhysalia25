...
The next step is the most important part of a Bayesian phylogenetic inference: **MCMC diagnostics**! Before you summarise the samples you have collected during the MCMC, you need to make sure that the chain has likely reached converged and that there have been no issues during sampling.<br>
...
## PART 4: Examples for you to get familiar with Bayesian inference
